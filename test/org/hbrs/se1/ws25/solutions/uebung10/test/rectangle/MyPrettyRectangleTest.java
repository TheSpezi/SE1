...
public class MyPrettyRectangleTest {
	...
	// Für den Test der Bounding Box
	private MyPrettyRectangle[] rect;
	...
	public void setUp() throws Exception { 
		...
		// Für den Tests der Bounding Box:
		rect = new MyPrettyRectangle[]{middle, right, somewhere};
	}
	...
	public void testGetBoundingBox( ) {
		...
		// MyPrettyRectangle[] rect = { middle, right, somewhere }; --> Move in SetUp!
	...
	@Test
	public void testObjectReturned() {
	...
	public void testBoundingBoxWithTenNonOverlappingRectangles() {
	    MyPrettyRectangle[] rects = new MyPrettyRectangle[] {
	        new MyPrettyRectangle(0, 0, 1, 1),
	        new MyPrettyRectangle(2, 2, 3, 3),
	        new MyPrettyRectangle(4, 4, 5, 5),
	        new MyPrettyRectangle(6, 6, 7, 7),
	        new MyPrettyRectangle(8, 8, 9, 9),
	        new MyPrettyRectangle(-2, -2, -1, -1),
	        new MyPrettyRectangle(-4, 1, -3, 2),
	        new MyPrettyRectangle(1, -5, 2, -4),
	        new MyPrettyRectangle(10, 0, 11, 1),
	        new MyPrettyRectangle(0, 10, 1, 11)
	    };

	    MyPrettyRectangle box = BoundingBoxFactory.createBoundingBox(rects);
	    assertNotNull(box);

	    // Erwartete Bounding Box: minX = -4, minY = -5, maxX = 11, maxY = 11
	    MyPrettyRectangle expected = new MyPrettyRectangle(-4, -5, 11, 11);
	    assertEquals(expected, box, "BoundingBox entspricht nicht der erwarteten Box für 10 nicht überlappende Rechtecke");
	}
