...
package org.hbrs.se1.ws25.solutions.uebung2.test;

import org.hbrs.se1.ws25.solutions.uebung2.*;
...
class ContainerTest {
    ...
    public void testAufNullVerschiedeneWege() {
            ...
            assertEquals(0 , container.size() ) ;
            assertEquals( e.getMessage() , "NULL-Werte dürfen nicht aufgenommen werden!");
        }
